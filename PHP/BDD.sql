...
CREATE TABLE IF NOT EXISTS CONTACT
 (
   ID int(11) NOT NULL AUTO_INCREMENT ,
   ID_UTILISATEUR int(11) NOT NULL  ,
   IDCONTACTANDROID int(11) NOT NULL  ,
   NOM CHAR(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
   NUMEROTEL1 CHAR(20) NULL  ,
   NUMEROTEL2 CHAR(20) NULL  ,
   EMAIL1 CHAR(100) NULL  ,
   EMAIL2 CHAR(100) NULL  ,
   ADRESSE CHAR(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL  ,
